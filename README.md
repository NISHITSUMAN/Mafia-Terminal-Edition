...
INSTRUCTIONS:
1) GO to your Terminal/Pycharm/Any IDE Terminal and install curses with this comand "pip install windows-curses" or do "pip install requirements.txt" in your cmd
